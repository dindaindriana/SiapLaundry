                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_user.php" method="POST">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        value="12345" <?php echo ($row['username'] == $_SESSION['username_siaplaundry']) ? 'disabled' : '' ; ?>>Hapus</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_reset_password.php" method="POST">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        value="12345" <?php echo ($row['username'] == $_SESSION['username_siaplaundry']) ? 'disabled' : '' ; ?>>Reset Password</button>
                                    </div>
                                </form>
                            </div>
                        </div>
