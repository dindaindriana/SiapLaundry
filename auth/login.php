                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate action="../proses/proses_login.php" method="POST">
                            ...
                            <div class="form-group">
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1 text"
                                        class="form-label text-success fw-medium">Email</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control border-success" id="inputPassword2"
                                        placeholder="Kata Sandi">
                                </div>
                                <button class="btn  btn-success w-100 mt-3 mb-3" type="submit" value="abc"
                                    name="login_validate">Masuk</button>
                            </div>
                        </form>
                    </div>
                </div>
